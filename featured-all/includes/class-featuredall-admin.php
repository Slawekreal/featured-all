        ...
        $this->render_field_wrapper(
            ...
            function() use ( $mode, $value ) {
                ...
                <div class="featuredall-slider-wrap" data-mode="<?php echo esc_attr( $mode ); ?>">
                    <input type="range" class="featuredall-width-slider" min="25" max="100" step="5" value="<?php echo esc_attr( $value ); ?>" />
                    <input type="range" class="featuredall-width-slider-px" min="320" max="1920" step="20" value="<?php echo esc_attr( $value ); ?>" />
                    ...
                    <span class="featuredall-width-unit"></span>
                </div>
                <?php
            }
        );
